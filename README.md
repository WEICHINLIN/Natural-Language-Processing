...
> pos_tweets and neg_tweets are in list format. If you want to use other data, you only need to classify the data and save it in str format into pos_tweets and neg_tweets.
